...
use DevGeneratorToolBundle\Generator\BundleGenerator;
use DevGeneratorToolBundle\Manipulator\KernelManipulator;
...
EOT
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        if (null === $namespace) {
            ...
            $namespace = $dialog->askAndValidate($output, $dialog->getQuestion('Bundle namespace', $input->getOption('namespace')), array('DevGeneratorToolBundle\Command\Validators', 'validateBundleNamespace'), false, $input->getOption('namespace'));
        ...
        if (null === $bundle) {
            ...
            $bundle = $dialog->askAndValidate($output, $dialog->getQuestion('Bundle name', $bundle), array('DevGeneratorToolBundle\Command\Validators', 'validateBundleName'), false, $bundle);
        ...
        if (null === $format) {
            ...
            $format = $dialog->askAndValidate($output, $dialog->getQuestion('Configuration format (yml, xml, php, or annotation)', $input->getOption('format')), array('DevGeneratorToolBundle\Command\Validators', 'validateFormat'), false, $input->getOption('format'));
