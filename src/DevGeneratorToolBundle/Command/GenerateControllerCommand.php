...
use DevGeneratorToolBundle\Generator\ControllerGenerator;
...
EOT
    ...
    public function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        while (true) {
            $controller = $dialog->askAndValidate($output, $dialog->getQuestion('Controller name', $input->getOption('controller')), array('DevGeneratorToolBundle\Command\Validators', 'validateControllerName'), false, $input->getOption('controller'));
        ...
        $routeFormat = $dialog->askAndValidate($output, $dialog->getQuestion('Routing format (php, xml, yml, annotation)', $defaultFormat), array('DevGeneratorToolBundle\Command\Validators', 'validateFormat'), false, $defaultFormat);
